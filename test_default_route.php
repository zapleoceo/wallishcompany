<?php
echo "<h1>Default Route Test</h1>";

// Simulate request with empty route
$_GET['route'] = '';
                ...
                if (method_exists($home_controller, 'index')) {
                    ...
                    try {
                        ...
                        if (strlen($output) > 0) {
                            ...
                            echo "<div style='background: #f0f0f0; padding: 10px; border: 1px solid #ccc; max-height: 200px; overflow: auto;'>";
