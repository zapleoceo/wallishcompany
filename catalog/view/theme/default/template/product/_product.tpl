...
<!-- Begin: main -->
    ...
    <section class="category category--product container">
        ...
        <div class="row">
            ...
            <div class="holiday-sidebar d-xl-block d-lg-block d-none col-lg-3 col-xl-2 col-auto">
            ...
            <div class="col-xl-10 col-lg-9 col-12">
                <div class="row">
                    <div class="col-photo col-sm-auto col-12 left">
                        <?php /* if ($thumb || $images): */ ?>
                            <?php /* if ($thumb):*/ ?>
                              <img class="product__photo" src="<?php echo $popup; ?>" alt="<?php echo $heading_title; ?>" />
                            <?php /*endif;*/ ?>
                            ...
                            <!-- BEGIN: slider -->
                                <div class="product-slider animated">
                                    ...
                                    <div class="item" data-origin="<?= $image['popup']; ?>">
                                        <img class="img" src="<?= $image['thumb']; ?>" alt="<?php echo $heading_title; ?>"/>
                                    </div>
                                    <?php endforeach; ?>
                                </div>
                            <?php endif; ?>
                        ...
                        <div class="product-info">
                            <div class="product-info__main-holder">
                                ...
                                <div class="product-info__price-holder">
                                    <?= ($special) ? '<div class="product-info__old">' . $price . '</div><div data-old="true" class="product-info__price">' . $special . '</div>' : '<div class="product-info__price">'.$price.'</div>'; ?>
                                </div>
                            ...
                            <div class="product-controls product-info__product-controls">
                                ...
                                <a href="#" title="<?= $text_add_cart; ?>" class="product-controls__bucket" data-product-id="<?php echo $product_id; ?>">
                                    <i class="icon">
                                        <svg version="1.1" id="Слой_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    ...
                                    <span class="text"><?= $text_to_backet; ?></span>
                                </a>
                            </div>
