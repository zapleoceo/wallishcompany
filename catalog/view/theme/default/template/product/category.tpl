...
<main class="main">
    <!-- BEGIN: breadcrumb -->
    <div class="category container d-xl-block d-lg-block d-md-block ">
        <div class="row">
            <div class="col-12">
					...
					<?php foreach ( $breadcrumbs as $bk => $br ): ?>
						...
						<?php if ( $bk == ( count( $breadcrumbs ) - 1 ) ): ?>
                            <li class="breadcrumb__item last">
                                <!--last_bread_link:<?= str_replace('https://wallishcompany.com','', $br['href']); ?>-->
                                <?php if ($bk == 2){
                                    echo "<!--seoshield_formulas--kategoriya-->";
                                }  
                                elseif ($bk == 3) {
                                    echo "<!--seoshield_formulas--podkategoriya-->";
                                } 
                                elseif ($bk == 1) {
                                    echo "<!--seoshield_formulas--kategoriya-->";
                                }
    ...
    <section class="category container">
        ...
        <div class="category__subtitle "><?= $text_category_subtitle; ?></div>
        <?php endif; ?>
        <!-- END: category children -->
        <!-- BEGIN: category content controls -->
        <div class="row d-none justify-content-xl-between justify-content-lg-between">
            <div class="col-md-5 col-sm-auto col-xs-12 col-12 d-xl-none d-lg-none d-block">
                <div class="top-drop">
                    <span class="top-drop__title"><?= $text_categories; ?></span>
                    <label class="top-drop__control top-drop__control--close">
                        <svg xmlns="http://www.w3.org/2000/svg" width="9" height="5" viewBox="0 0 9 5">
                            <path id="arrow-mini-down" class="cls-1"
                                  d="M231.056,880.819l-3.87-3.774a0.6,0.6,0,0,1,0-.869,0.643,0.643,0,0,1,.892,0l3.424,3.339,3.424-3.339a0.641,0.641,0,0,1,.891,0,0.6,0.6,0,0,1,0,.869l-3.87,3.774A0.641,0.641,0,0,1,231.056,880.819Z"
                                  transform="translate(-227 -876)"/>
                        </svg>
                    ...
                    <div class="top-drop__wrapper animated">
                        <ul class="sale">
                            <li class="sale__item">
                                <a href="<?= $new_cat['href']; ?>" class="sale__link" style="color: #43b9d4!important;"><?= $new_cat['name']; ?></a>
                                <label class="sub-items__quantity" style="color: #43b9d4!important;">(<?= $new_cat['count']; ?>)</label>
                            </li>
                        </ul>
                        <ul class="sale">
                            <li class="sale__item">
                        ...
                        <ul class="sale">
                            <li class="sale__item">
                                ...
                                <label class="sub-items__quantity">(<?= $fete_cat['count']; ?>)</label>
                            </li>
                        </ul>
                        <?php endif; ?>
                                        ...
                                        <ul class="sub-items sidebar__sub-items">
											<?php foreach ( $cat['children'] as $catch ): ?>
                                                <li class="sub-items__item">
                                                    <a href="<?= $catch['href']; ?>"
                                                       class="sub-items__link"><?= $catch['name']; ?></a>
                    ...
                    <label for="sharesNew" class="btn btn--new">
                        <i class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="12" viewBox="0 0 15 12">
                                <path class="cls-1"
                                      d="M496.772,830.492l-3.579-3.762L492,827.984,496.772,833,507,822.253,505.806,821Z"
                                      transform="translate(-492 -821)"/>
                            </svg>
                        </i>
            ...
            <!-- BEGIN: pagination top d-xl-block d-lg-block d-none col-auto -->
            <nav class="d-xl-block d-lg-block d-none col-auto">
                <ul class="pagination" data-view="<?php echo count( $products ) > 0 ? 'true' : 'false'; ?>">
					<?php echo $pagination; ?>
                </ul>
            </nav>
            <!-- END: pagination top -->

            <div class="col-auto d-xl-block d-lg-block d-md-block allprod-container"> <!-- HV-32 -->
                <div class="btn-holder btn-holder--2">
                    <a href="<?= $limit_all; ?>" class="allprod-link"></a>
        ...
        <div class="row">
            ...
            <div class=" d-none col-xl-2 col-3"><!-- d-xl-block d-lg-block -->
                <h4 class="sidebar__title"><?= $text_categories ?></h4>
                <ul class="sale">
                    <li class="sale__item">
                        <a href="<?= $new_cat['href'] ?>" class="sale__link"
                           style="color: #43b9d4"><?= $new_cat ['name'] ?></a>
                        <!--                        <label class="sub-items__quantity">(-->
						<? //= $new_cat['count']; ?><!--)</label>-->
                    </li>
                </ul>
                <ul class="sale">
                ...
                <ul class="sidebar category__sidebar">
					<?php foreach ( $categories as $cat ): $activesub = ''; ?>
						...
						<?php foreach ( $cat['children'] as $catch2 ): if ( $category_id == $catch2['category_id'] ) {
							$activesub = ' act';
							break;
						} endforeach; ?>
            ...
            <div class="col-xl-12 col-lg-12 col-12">
                <nav class=""><!-- d-xl-none d-lg-none -->
                    <div class="row justify-content-center">
                        <ul class="pagination col-auto"
                            data-view="<?php echo count( $products ) > 0 ? 'true' : 'false'; ?>">
							<?php echo $pagination; ?>
                        </ul>
                    </div>
                </nav>
                <div class="row">
                    <!--isset_listing_page-->
                    <?php
                    $products_ld_json = array();
                    ?>
					<?php foreach ( $products as $prod ): 
                        if (sizeof($products_ld_json) < 3){
                            $products_ld_json[] = ['@type' => 'ListItem', 'position' => sizeof($products_ld_json)+1,'url' => $prod['href']];
                        }
                        ?>
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="card animated fadeIn">
                                <!--<div><img class="" style="display: none;" src="<?= $prod['popup']; ?>" alt="<?= $prod['name']; ?>" title="<?= $prod['name']; ?>"></div>-->
                                <a href="<?= $prod['href']; ?>">
                                    <img class="card__image" src="<?= $prod['thumb']; ?>" alt="<?= $prod['name']; ?>" title="<?= $prod['name']; ?>">
                                </a>
                                <div data-pid="<?php echo $prod['product_id']; ?>"
                                     class="card__like<?= in_array( $prod['product_id'], $user_wishlist ) ? ' active' : ''; ?>">
                                ...
                                <?php if ( $prod['fete'] ): ?>
                                <div class="card__stock_icon" style="display: none"><span class="icon"></span></div>
                                <?php endif; ?>

                                <div class="card__body">
                                    <a href="<?= $prod['href']; ?>" class="card__text"><?= $prod['name']; ?></a>
                                    <p class="card__price-holder">
										<?= isset($text_price) && !empty($text_price) ? '<p class="card__text-price">'.$text_price.' </p>' : ''; ?><?= ( $prod['special'] ) ? '<p class="card__old-price">' . $prod['price'] . '</p> <p class="card__new-price">' . $prod['special'] . '</p>' : '<p class="card__new-price">' . $prod['price'] . '</p>'; ?>
                                    </p>
                                    <p class="card__code"><?= $prod['model']; ?></p>
                                </div>
                                <div class="card__footer">
                                    <button class="card__btn minus"></button>
                                    <div class="card__counter" data-min="<?php echo $prod['minimum']; ?>"><input
                                                type="text" value="<?php echo $prod['minimum']; ?>"></div>
                                    <button class="card__btn plus"></button>


                                    <a href="#" title="<?= $text_add_cart; ?>" class="card__bucket card__bucket__no_icon"
                                       data-product-id="<?php echo $prod['product_id']; ?>" data-text-in-backet="<?= $text_in_backet; ?>"><?= $text_add_cart; ?>
                                        <?php
                                        /*<i class="icon">
                                            <svg version="1.1" id="Слой_1" xmlns="http://www.w3.org/2000/svg"
                                                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                ...
                                                <g id="Page-1">
                                                    <g id="_x30_1-main" transform="translate(-1840.000000, -33.000000)">
                                                        <g id="cart" transform="translate(1840.000000, 33.000000)">
                                                            ...
                                                            <circle id="Oval_1_" class="st0" cx="12.5" cy="14.5"
                                                                    r="1.5"/>
                                                        </g>
                                                    </g>
                                                </g>
					...
					<?php endforeach; ?>
                    <?php
                    if (sizeof($products_ld_json) > 0){
                        ?>
                        <script type="application/ld+json">
                        {
                            "@context":"http://schema.org",
                            "@type":"ItemList",
                            "itemListElement" : <?= json_encode($products_ld_json); ?>
                        }
                        </script>
                        <?php
                    }
                    ...
                    <div class="col-sm-12 seo_text">
                        <div id="seo_text_place" class="seo_text_place"><!--seo_text_start--><!--seo_text_end--></div>
