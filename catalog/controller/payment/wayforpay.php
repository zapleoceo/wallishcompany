...
class ControllerPaymentWayforpay extends Controller
{
    ...
    public function index()
    {
        ...
        // добавляем условия если есть выбранная карта
    ...
    public function confirm()
    {
        ...
        if ($order_info['order_status_id'] == 0) {
            $this->model_checkout_order->addOrderHistory($order_id, $this->config->get('wayforpay_order_status_id'), 'WayForPay', false);
        }
    }
    ...
    public function response()
    {
        ...
        $this->response->redirect($this->url->link('checkout/confirm/result', '', 'SSL'));
        ...
        if ($paymentInfo === true) {
            ...
            $this->response->redirect($this->url->link('checkout/confirm/result', '', 'SSL')); // checkout/success/result
        } else {
