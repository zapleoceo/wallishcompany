...
class ControllerBlogCategory extends Controller {
	public function index() {
		...
		if ($category_info) {
			...
			foreach ($results as $result) {
				if ($result['image']) {
          $image = $this->model_tool_image->resize($result['image'], 450 /*$this->config->get('configblog_image_article_width')*/, 450 /*$this->config->get('configblog_image_article_height')*/ );
				} else {
