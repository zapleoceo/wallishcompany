...
class ControllerAccountEdit extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate() /*&& $this->validate_pass()*/) {
            ...
            if (isset($this->request->post['repass']) && $this->request->post['repass'] = 1 && $this->validate_pass()) {
		...
		$data['breadcrumbs'][] = array(
			'text'      => $this->language->get('text_account_'),
