...
/*
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $customer_id = $this->model_account_customer->addCustomerMin($this->request->post);
...
*/
        ...
        $this->error = isset($this->session->data['error_checkout_register']) ? $this->session->data['error_checkout_register'] : array();
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/register.tpl')) {
			...
			return $this->load->view('default/template/checkout/register.tpl', $data);
		}
	}
