...
class ControllerCheckoutLogin extends Controller {
	public function index() {
        ...
        $data['sectred'] = isset($this->request->get['sect']) ? $this->request->get['sect'] : 'login';
        ...
        $this->error = isset($this->session->data['error_checkout_login']) ? $this->session->data['error_checkout_login'] : array();
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/login.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/checkout/login.tpl', $data);
		} else {
			return $this->load->view('default/template/checkout/login.tpl', $data);
		}
	}
