...
$_['text_steps_cart']         					= 'Корзина';
$_['text_steps_login']         					= 'Ваши данные';
$_['text_steps_shiping']         				= 'Доставка';
$_['text_steps_pay']         					= 'Оплата';
$_['text_steps_more']         					= 'Далее';
$_['text_continue_bay']                         = 'Продолжить покупки';


$_['text_min_summ_order']                       = 'Минимальная сумма заказа';
$_['text_adding']                               = ' Добавьте еще';
$_['text_to_order']                             = ' к заказу';

$_['text_not_order']                            = 'Отменить заказ';
$_['text_column_category']                      = 'Категория';

$_['text_check_cart']                           = 'Проверьте, пожалуйста, свою корзину. Она могла дополниться товарами, которые вы добавляли ранее.';
