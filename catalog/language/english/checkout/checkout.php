...
$_['text_get_order_address']         = 'You can pick up the order at:';
...
$_['entry_edit'] 	                 = 'Edit';
$_['entry_send_name_company'] 	     = 'SEND TO COMPANY NAME';
$_['entry_address_default'] 	     = 'SET DEFAULT ADDRESS';
$_['entry_address_add_new'] 	     = 'Add  a new shipping address';
$_['entry_address_title'] 	     	 = 'Адрес доставки';

$_['entry_comment_order'] 	         = 'Your comment';
$_['entry_information'] 	         = 'When you confirm the order we will suggest you delivery options.
												Delivery outside Ukraine is not included in the price but could be arranged at additional cost after agreeing the delivery details';
$_['entry_save'] 	                 = 'Save';


$_['entry_lastname'] 	             = 'LAST NAME';
$_['entry_firstname'] 	             = 'FIRST NAME';
$_['entry_delivery_kiev_free'] 	     = 'Delivery BY COURIER FOR KIEV <br> 100 UAH';
$_['entry_next']					 = 'Checkout';
$_['entry_delivery_np_free'] 		 = 'Delivery to the “Nova poshta” <br> (accordint to NPs rate)';

$_['entry_np_option_default'] 		 = 'Choose depot';
$_['entry_city_option'] 			 = 'CITY ';
$_['entry_np_num'] 					 = 'NAME OF DEPOT';

$_['text_title'] 					 = 'To Cart';
$_['text_home'] 					 = 'back to Home Page';
$_['text_catalog'] 					 = 'go to catalog';

$_['text_message'] 					 = 'Thank you for your order! Our manager will contact you soo';
$_['text_message_beznal'] 			 = 'Thank you for your order! Our manager will contact you soo';

$_['button_confirm'] 				 = 'Confirm';


$_['text_delivery_ukraine'] 			= 'Delivery to Ukraine';
$_['text_delivery_other_internacional'] = 'Worldwide delivery';
$_['text_delivery_to_np'] = 'To the depot “Nova poshta”  <br> (accordint to NPs rate)';
$_['text_delivery_to_kiev'] = 'By courier for Kiev <br> (100 UAH)';
$_['text_delivery_to_samovivoz'] = 'Self pick-up';
