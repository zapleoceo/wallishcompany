...
class ModelAccountCustomer extends Model {
	...
	public function addCustomerMin($data, $nosend = false, $nostartadress = false) {
	...
	private function filterGuestCustomer($row) {
	    if (empty($row))
	        return $row;

	    if ($row['firstname'] == 'quest') {
            $row['email'] = '';
            $row['firstname'] = '';
            $row['is_guest'] = 1;
        }
	...
	public function getCustomer($customer_id) {
		...
		return $this->filterGuestCustomer($query->row);
	}
