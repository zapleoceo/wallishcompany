...
<div class="container">
  ...
  <div style="page-break-after: always;" class="orders-pdf">
  ...
  <?php } ?>
    ...
    <?php if ($ispdf): ?>
      <form style="display:none;" method="post" class="formPdf">
      ...
      <script>
        $(document).ready(function(){
            ...
            var count = $('.orders-pdf').length;

            $('.orders-pdf').each(function(){
                ...
                html2canvas(this).then(canvas => {
                    ...
                    $('.formPdf').append('<input type="hidden" value="'+img+'" name="image[]">');
