  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <button type="submit" id="button-pdf" form="form-order" formaction="<?php echo $invoice; ?>&pdf=1" data-toggle="tooltip" title="PDF" class="btn btn-warning"><i class="fa fa-print"></i></button>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right">
                      <div class="btn-group">
                          <select name="order_status_id" class="form-control update-order-status" data-order_id="<?php echo $order['order_id']; ?>">
                              <?php foreach ($order_statuses as $order_status) { ?>
                    ...
                    <button type="button" value="<?php echo $order['order_id']; ?>" id="button-delete<?php echo $order['order_id']; ?>" data-loading-text="<?php echo $text_loading; ?>" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger">
...
$('input[name^=\'selected\']').on('change', function() {
	...
	if (selected.length) {
		$('#button-invoice, #button-pdf').prop('disabled', false);
	}
...
$('select.update-order-status').on('change', function (e) {
    var order_id = $(this).data('order_id');
    var status_id = $(this).val();

    $.ajax({
        url: 'index.php?route=sale/order/changestatus&token=<?php echo $token; ?>&order_id=' + order_id,
        type: 'post',
        data: {
            status_id: status_id
        },
