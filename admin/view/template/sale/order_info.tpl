...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a href="<?php echo $invoice; ?>&pdf=1" target="_blank" data-toggle="tooltip" title="PDF" class="btn btn-warning">
          <i class="fa fa-print"></i>
        </a>
  ...
  <div class="container-fluid">
          ...
          <tbody>
            ...
            <tr>
              <td class="text-left"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
                ...
                <?php } ?>
                <?php } ?>
                  <button type="button" class="button-order_product_image btn btn-primary btn-xs" data-img_link="<?= $product['image']['thumb'] ?>"><i class="fa fa-eye"></i></button>
              </td>
    ...
    <div id="modal-order_product_image" class="modal" style="display: none; padding-right: 15px;">
