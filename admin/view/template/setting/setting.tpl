        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
                ...
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-address_en"><?php echo $entry_address; ?> UK</label>
                  <div class="col-sm-10">
                    <textarea name="config_address[uk]" placeholder="<?php echo $entry_address; ?>" rows="5" id="input-address_en" class="form-control"><?php echo $config_address['uk']; ?></textarea>
                ...
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-address_ru"><?php echo $entry_address; ?> RU</label>
                  <div class="col-sm-10">
                    <textarea name="config_address[ru]" placeholder="<?php echo $entry_address; ?>" rows="5" id="input-address_ru" class="form-control"><?php echo $config_address['ru']; ?></textarea>
                    <?php if ($error_address) { ?>
                    <div class="text-danger"><?php echo $error_address; ?></div>
                    <?php } ?>
                  </div>
                ...
                <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-address_en"><?php echo $entry_address; ?> EN</label>
                    <div class="col-sm-10">
                        <textarea name="config_address[en]" placeholder="<?php echo $entry_address; ?>" rows="5" id="input-address_en" class="form-control"><?php echo $config_address['en']; ?></textarea>
                        <?php if ($error_address) { ?>
                        <div class="text-danger"><?php echo $error_address; ?></div>
                        <?php } ?>
                    </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-open"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_open; ?>"><?php echo $entry_open; ?> UK</span></label>
                  <div class="col-sm-10">
                    <textarea name="config_open[uk]" rows="1" placeholder="<?php echo $entry_open; ?>" id="input-open" class="form-control"><?php echo $config_open['uk']; ?></textarea>
                  </div>
                  <label class="col-sm-2 control-label" for="input-open"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_open; ?>"><?php echo $entry_open2; ?></span></label>
                  <div class="col-sm-10">
                    <textarea name="config_open2[uk]" rows="1" placeholder="<?php echo $entry_open2; ?>" id="input-open" class="form-control"><?php echo $config_open2['uk']; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-open"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_open; ?>"><?php echo $entry_open; ?> RU</span></label>
                  <div class="col-sm-10">
                    <textarea name="config_open[ru]" rows="1" placeholder="<?php echo $entry_open; ?>" id="input-open" class="form-control"><?php echo $config_open['ru']; ?></textarea>
                  </div>
				  <label class="col-sm-2 control-label" for="input-open"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_open; ?>"><?php echo $entry_open2; ?></span></label>
                  <div class="col-sm-10">
                    <textarea name="config_open2[ru]" rows="1" placeholder="<?php echo $entry_open2; ?>" id="input-open" class="form-control"><?php echo $config_open2['ru']; ?></textarea>
                  </div>
                </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-open"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_open; ?>"><?php echo $entry_open; ?> EN</span></label>
                <div class="col-sm-10">
                  <textarea name="config_open[en]" rows="1" placeholder="<?php echo $entry_open; ?>" id="input-open" class="form-control"><?php echo $config_open['en']; ?></textarea>
                </div>
				  <label class="col-sm-2 control-label" for="input-open"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_open; ?>"><?php echo $entry_open2; ?></span></label>
                  <div class="col-sm-10">
                    <textarea name="config_open2[en]" rows="1" placeholder="<?php echo $entry_open2; ?>" id="input-open" class="form-control"><?php echo $config_open2['en']; ?></textarea>
                  </div>
              </div>
                <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-fax"><?php echo $entry_link_facebook; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_link_facebook" value="<?php echo $config_link_facebook; ?>" placeholder="<?php echo $entry_link_facebook; ?>" id="input-link_facebook" class="form-control" />
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-fax"><?php echo $entry_link_instagramm; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_link_instagramm" value="<?php echo $config_link_instagramm; ?>" placeholder="<?php echo $entry_link_instagramm; ?>" id="input-link_instagramm" class="form-control" />
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-fax"><?php echo $entry_link_pinterest; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_link_pinterest" value="<?php echo $config_link_pinterest; ?>" placeholder="<?php echo $entry_link_pinterest; ?>" id="input-link_pinterest" class="form-control" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="config_country_id" id="input-country" class="form-control">
                    ...
                    <?php if ($country['id'] == $config_country_id) { ?>
