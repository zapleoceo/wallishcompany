      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-privat24" class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="privat24_merchant" value="<?php echo $privat24_merchant; ?>" placeholder="<?php echo $entry_merchant; ?>" id="input-merchant" class="form-control" />
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="privat24_password"><?php echo $entry_password; ?></label>
            <div class="col-sm-10">
              <input type="text" name="privat24_password" value="<?php echo $privat24_password; ?>" placeholder="<?php echo $entry_password; ?>" id="privat24_password" class="form-control" />
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="privat24_currency"><?php echo $entry_currency; ?></label>
            <div class="col-sm-10">
              <?php $currencies = array('UAH','USD','EUR'); ?>
              <select name="privat24_currency" id="privat24_currency" class="form-control">
              <option value="0"><?php echo $text_currency; ?></option>
              <?php foreach ($currencies as $currency) { ?>
              <?php if ($currency == $privat24_currency) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="privat24_total" value="<?php echo $privat24_total; ?>" placeholder="<?php echo $entry_total; ?>" id="input-total" class="form-control" />
            </div>
          </div>
          ...
          <div class="form-group">
           ...
           <div class="col-sm-10">
                <select name="privat24_order_status_id">
