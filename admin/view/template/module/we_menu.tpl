								...
								<?php 
									...
									if ($item['item']) {
										if (is_array($item['item']))
											$tab_name = $item['item'][key($item['item'])];
										else
											$tab_name = $item['item'];
						...
						<div class="col-sm-10">
							<div class="tab-content">
								...
								<div class="tab-pane active" id="tab-menu-item-<?php echo $i; ?>">
									...
									<?php if ($item['item_type'] != 'article_link'): $f = 0; ?>
										<?php foreach($languages as $kl => $lang): $f++; ?>
											<div class="form-group">
												<label class="col-sm-2 control-label" for="input-item-<?php echo $i.$kl; ?>">
													<?php echo $entry_item; ?> (<?= $lang['code']; ?>)
												</label>
												<div class="col-sm-10">
													<input type="text" class="form-control tab-handler-name" data-tab-handler="#tab-menu-item-handler-<?php echo $i; ?>" value="<?php echo $item['item'][$lang['language_id']]; ?>" name="we_menu[<?php echo $i; ?>][item][<?= $lang['language_id']; ?>]" id="input-item-<?php echo $i.$kl; ?>" placeholder="<?php echo $entry_item; ?>" />
													<?php if ($f ==1 && $error_item && isset($error_item[$i])) { ?>
									...
									<?php else: ?>
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-item-<?php echo $i; ?>">
												<?php echo $entry_item; ?>
											</label>
											<div class="col-sm-10">
