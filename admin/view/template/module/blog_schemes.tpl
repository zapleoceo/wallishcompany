...
function delayer(){
    window.location = 'index.php?route=agoo/blog/schemes&<?php echo $token_name; ?>=<?php echo $token; ?>';
}
</script>
   ...
   <tbody class="view_status <?php echo 'view_status_'.$widget_type; ?>" data-widget-class = "view_status_<?php echo $widget_type; ?>">
         ...
         <tr class="module-row<?php echo $module_row; ?>">
          ...
          <tr class="module-row<?php echo $module_row; ?>">
            ...
            <select class="form-control no_change" name="blog_module[<?php echo $module_row; ?>][position]">
