      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-order-status" class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <?php $code = ''; foreach ($languages as $language) { $code = $order_status[$language['language_id']]['code']; ?>
              ...
              <div class="input-group">
                <input type="text" name="order_status[<?= $language['language_id']; ?>][code]" value="<?= $code; ?>" placeholder="code" class="form-control" />
              </div>
