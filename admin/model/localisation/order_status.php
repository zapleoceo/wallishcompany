...
class ModelLocalisationOrderStatus extends Model {
	public function addOrderStatus($data) {
		...
		foreach ($data['order_status'] as $language_id => $value) {
			if (isset($order_status_id)) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "order_status SET order_status_id = '" . (int)$order_status_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', code = '" . $this->db->escape($code) . "'");
			} else {
				$this->db->query("INSERT INTO " . DB_PREFIX . "order_status SET language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', code = '" . $this->db->escape($code) . "'");
	...
	public function getOrderStatusDescriptions($order_status_id) {
		...
		/*foreach($order_status_data as $k => $res) {
            $order_status_data[$k]['code'] = $code;
        }*/
