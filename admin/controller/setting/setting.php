...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_open2'] = $this->language->get('entry_open2');
        ...
        $data['entry_link_facebook'] = $this->language->get('entry_link_facebook');
        $data['entry_link_instagramm'] = $this->language->get('entry_link_instagramm');
        $data['entry_link_pinterest'] = $this->language->get('entry_link_pinterest');
        ...
        $data['config_address'] = json_decode($data['config_address'], true);
        ...
        if (isset($this->request->post['config_link_facebook'])) {
            $data['config_link_facebook'] = $this->request->post['config_link_facebook'];
        } else {
            $data['config_link_facebook'] = $this->config->get('config_link_facebook');
        }

        if (isset($this->request->post['config_link_instagramm'])) {
            $data['config_link_instagramm'] = $this->request->post['config_link_instagramm'];
        } else {
            $data['config_link_instagramm'] = $this->config->get('config_link_instagramm');
        }

        if (isset($this->request->post['config_link_pinterest'])) {
            $data['config_link_pinterest'] = $this->request->post['config_link_pinterest'];
        } else {
            $data['config_link_pinterest'] = $this->config->get('config_link_pinterest');
        }
        /* ================== */
		...
		if (isset($this->request->post['config_open'])) {
            $this->request->post['config_open'] = json_encode($this->request->post['config_open']);
			$data['config_open'] = $this->request->post['config_open'];
		} else {
			$data['config_open'] = $this->config->get('config_open');
		}
	
		if (isset($this->request->post['config_open2'])) {
            $this->request->post['config_open2'] = json_encode($this->request->post['config_open2']);
			$data['config_open2'] = $this->request->post['config_open2'];
		} else {
			$data['config_open2'] = $this->config->get('config_open2');
		}
	...
	protected function validate() {
        ...
        if (!is_array($this->request->post['config_address'])) {
            $this->error['address'] = $this->language->get('error_address');
        } else {
            foreach ($this->request->post['config_address'] as $lng => $address) {
                if ((utf8_strlen($this->request->post['config_address'][$lng]) < 3) || (utf8_strlen($this->request->post['config_address'][$lng]) > 256)) {
                    $this->error['address'] = $this->language->get('error_address');
                    break;
                }
            }

            if(empty($this->error['address'])) {
                $this->request->post['config_address'] = json_encode($this->request->post['config_address']);
            }
        }
