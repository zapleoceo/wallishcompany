...
class ControllerLocalisationCurrency extends Controller {
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['symbol_left']['uk'])) {
            $data['symbol_left']['uk'] = $this->request->post['symbol_left']['uk'];
        } elseif (!empty($currency_info)) {
            $data['symbol_left']['uk'] = $currency_info['symbol_left']['uk'];
        } else {
            $data['symbol_left']['uk'] = '';
        }

		if (isset($this->request->post['symbol_left']['ru'])) {
			$data['symbol_left']['ru'] = $this->request->post['symbol_left']['ru'];
		} elseif (!empty($currency_info)) {
			$data['symbol_left']['ru'] = $currency_info['symbol_left']['ru'];
		} else {
			$data['symbol_left']['ru'] = '';
		}

        if (isset($this->request->post['symbol_left']['en'])) {
            $data['symbol_left']['en'] = $this->request->post['symbol_left']['en'];
        } elseif (!empty($currency_info)) {
            $data['symbol_left']['en'] = $currency_info['symbol_left']['en'];
        } else {
            $data['symbol_left']['en'] = '';
        }

        if (isset($this->request->post['symbol_right']['uk'])) {
            $data['symbol_right']['uk'] = $this->request->post['symbol_right']['uk'];
        } elseif (!empty($currency_info)) {
            $data['symbol_right']['uk'] = $currency_info['symbol_right']['uk'];
        } else {
            $data['symbol_right']['uk'] = '';
        }

        if (isset($this->request->post['symbol_right']['ru'])) {
            $data['symbol_right']['ru'] = $this->request->post['symbol_right']['ru'];
        } elseif (!empty($currency_info)) {
            $data['symbol_right']['ru'] = $currency_info['symbol_right']['ru'];
        } else {
            $data['symbol_right']['ru'] = '';
        }

		if (isset($this->request->post['symbol_right']['en'])) {
			$data['symbol_right']['en'] = $this->request->post['symbol_right']['en'];
		} elseif (!empty($currency_info)) {
			$data['symbol_right']['en'] = $currency_info['symbol_right']['en'];
		} else {
			$data['symbol_right']['en'] = '';
		}
