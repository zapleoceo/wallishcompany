...
class ControllerCatalogCategory extends Controller {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            if (!empty($range_price)) {
                ...
                foreach($range_price as $index => $rprice) {
                    ...
                    $dataupdate[$path] = (int)$rprice;
                }

                $this->load->model('setting/setting');

                $this->model_setting_setting->editSetting('cpcats_' . $category_id, $dataupdate);
            }*/
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $category_id) {
                ...
                $this->model_setting_setting->deleteSetting('cpcats_' . $category_id);
			}
	...
	protected function getForm() {
		...
		// prices Range
        /*$params = isset($this->request->get['category_id']) ? array('category_id' => $this->request->get['category_id']) : array();
